...
# https://forum.arduino.cc/index.php?topic=370810.msg2566409#msg2566409
...
arduinoIdeVersion["1.8.9"] = "/usr/local/bin/arduino"

	#	where are libraries stored (/mnt/sdb1/SGT-Prog/Arduino/ is my Sketchbook directory)
arduinoExtraLibraries = "/home/pi/robotics/utils/arduino/libraries"

	#	where this program will store stuff
	#		these directories will be beside this Python program
compileDirName = "/home/pi/robotics/utils/arduino/ArduinoTemp"
archiveDirName = "/home/pi/robotics/utils/arduino/ArduinoUploadArchive"

	#	default build options
buildOptions = {}
buildOptions["action"] = "upload"
buildOptions["board"] = "arduino:avr:mega:cpu=atmega2560"
buildOptions["port"] = "/dev/ttyACM0"
buildOptions["ide"] = "1.8.9"
